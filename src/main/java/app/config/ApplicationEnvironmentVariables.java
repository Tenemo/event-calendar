...
public final class ApplicationEnvironmentVariables {
    ...
    public static final String BOOTSTRAP_INVITATION_TOKEN = "APP_BOOTSTRAP_INVITATION_TOKEN";
    public static final String DEFAULT_TIME_ZONE = "APP_DEFAULT_TIME_ZONE";
